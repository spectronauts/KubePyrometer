...
**Container images.** The harness bundles `busybox:1.36.1` and `bitnami/kubectl:latest` as `lib/images/harness-images.tar`. These are unmodified upstream images. To verify integrity, rebuild the tar from upstream sources:
